...
$('#sem').change(function (){
    ...
    $.get("/assignment/edit/"+document.getElementById("sem").value,function(data,status){
        ...
        const newQ = '<br><div class="form-group row"><div class="col-2"><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal">Add New Question</button></div><div class="col-2"><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#oldQues">Insert Old Question</button></div></div>';
